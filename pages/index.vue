...
// This is the useHead composable with your SEO metadata
useHead({
  ...
  meta: [
    ...
    { property: 'og:url', content: 'https://khunkimhong.github.io/Portfolio/' },
  ],
  link: [
    { rel: 'canonical', href: 'https://khunkimhong.github.io/Portfolio/' }
  ]
})
</script>
